...
Page({
  ...
  add: function (card_id, rd_session, musicurl, page_data) {
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        wx.redirectTo({
          url: '../newYear_four/ny_four_index?order_id=' + res.data.data.order_id + '&card_id=' + card_id + '&added=1' + '&r_timer=' + that.data.r_timer
        })
      }
    })
  },
  ...
  onLoad: function (options) {
    ...
    if (order_id) {
      ...
      that.setData({
        content: "新年快乐，新的一年新的开始，祝大家在新年里事事顺利，天天发财,日日开心，越来越胖~哈哈哈哈哈 ……"
      });
      }
  ...
  onShareAppMessage: function (res) {
    ...
    return {
      ...
      path: '/pages/happyNewYear/newYear_four/ny_four_index?order_id=' + order_id + '&sended=1' + '&r_timer=' + that.data.r_timer,
