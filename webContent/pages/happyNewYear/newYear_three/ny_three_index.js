...
Page({
  ...
  add: function (card_id, rd_session, musicurl, page_data) {
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        wx.redirectTo({
          url: '../newYear_three/ny_three_index?order_id=' + res.data.data.order_id + '&card_id=' + card_id + '&added=1' + '&r_timer=' + that.data.r_timer,
        })
      }
    })
  },
  ...
  onLoad: function (options) {
    ...
    if (order_id) {
      ...
      that.setData({
        content: "有些事并不因时光而褪去，有些人不因不常见面而忘记，记忆里你是我永远的朋友，迎新之际，恭祝事业蒸蒸日上。"
      });
      }
  ...
  onShareAppMessage: function (res) {
    ...
    return {
      ...
      path: '/pages/happyNewYear/newYear_three/ny_three_index?order_id=' + order_id + '&sended=1' + '&r_timer=' + that.data.r_timer,
