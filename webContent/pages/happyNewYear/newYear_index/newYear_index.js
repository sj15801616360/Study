...
// pages/happyNewYear/happyNewYear.js
Page({
  ...
  add: function (card_id, rd_session, musicurl, page_data) {
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        wx.redirectTo({
          url: '../newYear_index/newYear_index?order_id=' + res.data.data.order_id + '&card_id=' + card_id + '&added=1' + '&r_timer=' + that.data.r_timer,
        })
      }
    })
  },
  ...
  onShareAppMessage: function (res) {
    ...
    console.log('/pages/newYear_index/newYear_index?order_id=' + order_id)
    return {
      title: '您收到了来自' + nickName + '的祝福',
      path: '/pages/happyNewYear/newYear_index/newYear_index?order_id=' + order_id + '&sended=1' + '&r_timer=' + that.data.r_timer,
