...
Page({
  ...
  add: function (card_id, rd_session, musicurl, page_data) {
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        wx.redirectTo({
          url: '../christmas_index/christmas_index?order_id=' + res.data.data.order_id + '&card_id=' + card_id + '&added=1' + '&r_timer=' + that.data.r_timer
        })
      }
    })
  },
  ...
  onShareAppMessage: function (res) {
    ...
    return {
      ...
      path: '/pages/christmas/christmas_index/christmas_index?order_id=' + order_id + '&sended=1' + '&r_timer=' + that.data.r_timer,
