...
// pages/christmas01/christmas01_index/christmas01_index.js
Page({
  ...
  onLoad: function (options) {
    ...
    if (order_id) {
      ...
      that.setData({
        header: "亲爱的：",
        content: "今天是圣诞节，圣诞老公公今天很忙， 特地要我代替他老人家来完成你的心愿你走到窗前，闭上眼对着天空数到三，愿望就能实现，圣诞节快乐!"
      });
     }
  ...
  add: function (card_id, rd_session, musicurl, page_data) {
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        wx.redirectTo({
          url: '../christmas01_index/christmas01_index?order_id=' + res.data.data.order_id + '&card_id=' + card_id + '&added=1'+'&r_timer='+that.data.r_timer,
        })
      }
    })
  },
  ...
  onShareAppMessage: function (res) {
    ...
    return {
      ...
      path: '/pages/christmas/christmas01_index/christmas01_index?order_id=' + order_id + '&sended=1' + '&r_timer=' + that.data.r_timer,
