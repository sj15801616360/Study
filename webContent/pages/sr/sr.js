...
Page({
  ...
  add: function (card_id, rd_session, musicurl, page_data) {
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        wx.redirectTo({
          url: '../sr/sr?order_id=' + res.data.data.order_id + '&card_id=' + card_id+'&added=1'+'&r_timer='+that.data.r_timer
        })
      }
    })
  },
  ...
  onLoad: function (options) {
    ...
    if (order_id) {
      ...
      that.setData({
        content: "今天是你的生日，为你送上一 份生日祝福：点燃生日的红蜡，留 住这段美好的记忆；在生日快乐的 歌声中陶醉！愿你快乐每一天！"
      });
    }
  ...
  onShareAppMessage: function (res) {
    ...
    return {
      ...
      path: '/pages/sr/sr?order_id=' + order_id + '&sended=1' + '&r_timer=' + that.data.r_timer,
